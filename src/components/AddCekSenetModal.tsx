...
import { X, ChevronDown, FileText, ArrowDownLeft, ArrowUpRight } from 'lucide-react-native';
...
export default function AddCekSenetModal({ visible, onClose }: AddCekSenetModalProps) {
      ...
      >
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.typeRow}>
            <TouchableOpacity
              style={[styles.typeButton, type === 'cek' && styles.typeButtonActive]}
              onPress={() => setType('cek')}
            >
              <FileText size={20} color={type === 'cek' ? '#fff' : '#6366f1'} />
              <Text style={[styles.typeText, type === 'cek' && styles.typeTextActive]}>Çek</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.typeButton, type === 'senet' && styles.typeButtonActive]}
              onPress={() => setType('senet')}
            >
              <FileText size={20} color={type === 'senet' ? '#fff' : '#6366f1'} />
              <Text style={[styles.typeText, type === 'senet' && styles.typeTextActive]}>Senet</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.typeRow}>
            <TouchableOpacity
              style={[styles.directionButton, direction === 'alacak' && styles.directionButtonAlacak]}
              onPress={() => setDirection('alacak')}
            >
              <ArrowDownLeft size={20} color={direction === 'alacak' ? '#fff' : '#10b981'} />
              <Text style={[styles.typeText, direction === 'alacak' && styles.typeTextActive]}>
                Alacak (Tahsil Edilecek)
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.directionButton, direction === 'borc' && styles.directionButtonBorc]}
              onPress={() => setDirection('borc')}
            >
              <ArrowUpRight size={20} color={direction === 'borc' ? '#fff' : '#ef4444'} />
              <Text style={[styles.typeText, direction === 'borc' && styles.typeTextActive]}>
                Borç (Ödenecek)
              </Text>
            </TouchableOpacity>
          </View>
          ...
          {/* Seri No */}
          <Text style={styles.label}>{type === 'cek' ? 'Çek No' : 'Senet No'}</Text>
          <TextInput
            style={styles.input}
            value={serialNumber}
