        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.typeButtons}>
            <TouchableOpacity
              style={[
                styles.typeButton,
                type === "tedarikci" && styles.typeButtonActive,
              ]}
              onPress={() => setType("tedarikci")}
            >
              <Building2
                size={20}
                color={type === "tedarikci" ? "#fff" : "#6b7280"}
              />
              <Text
                style={[
                  styles.typeButtonText,
                  type === "tedarikci" && styles.typeButtonTextActive,
                ]}
              >
                Tedarikçi
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.typeButton,
                type === "musteri" && styles.typeButtonActive,
              ]}
              onPress={() => setType("musteri")}
            >
              <Users
                size={20}
                color={type === "musteri" ? "#fff" : "#6b7280"}
              />
              <Text
                style={[
                  styles.typeButtonText,
                  type === "musteri" && styles.typeButtonTextActive,
                ]}
              >
                Müşteri
              </Text>
